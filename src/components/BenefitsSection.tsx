...
const BenefitsSection = () => {
  return (
    <section id="beneficios" className="py-20 px-4 bg-background relative overflow-hidden">
      ...
      <div className="max-w-4xl mx-auto text-center relative z-10">
        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-3xl mx-auto">
          {benefits.map((benefit, index) => (
            <div 
              key={benefit}
              className="flex items-center space-x-4 p-5 bg-warm-cream rounded-xl border border-warm-earth/20 hover:shadow-warm hover:scale-105 hover:border-accent/30 transition-all duration-300 animate-scale-in group cursor-pointer"
        ...
        <div className="mt-12 p-8 bg-gradient-primary rounded-2xl text-center animate-fade-in shadow-glow relative overflow-hidden">
          ...
          <p className="font-script text-2xl md:text-3xl text-primary-foreground relative z-10">
